...
||| 16 | Exportação por capítulos — modelo, pipeline, frontend | completed | high | task_05, task_09 |
||| 17 | Testes de integração — pipeline por capítulos, capítulos API | new | high | task_15, task_16 |
||| 18 | Download por capítulo — HTMX na detail page | new | low | task_16 |
